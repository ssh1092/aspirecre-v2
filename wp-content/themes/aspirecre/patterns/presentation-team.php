...
echo aspire_hp_group( aspire_hp_group( $transition . $intro, 'hp-shell hp-section-intro' ) . aspire_hp_block( 'aspire-core/team-grid', array( 'count' => 8, 'presentation' => 'portraits', 'hideWhenEmpty' => true ) ) . aspire_hp_group( aspire_hp_link( 'Start a conversation with Aspire ↗', 'tel:+17139332001' ), 'hp-shell' ), 'hp-section hp-team-section', 'human-expertise', 'section', 'Real Aspire people' );
