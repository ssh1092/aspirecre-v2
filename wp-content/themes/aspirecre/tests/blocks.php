...
$walk( $top );
foreach ( $flat as $block ) { aspirecre_block_check( str_starts_with( $block['blockName'], 'core/' ) && ! in_array( $block['blockName'], array( 'core/html', 'core/freeform' ), true ), 'Native editable ' . $block['blockName'] ); }
...
aspirecre_block_check( 3 === $types['core/shortcode'], 'Only finder and two record collections use shortcodes' );
