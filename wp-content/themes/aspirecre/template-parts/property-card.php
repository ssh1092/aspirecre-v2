...
<article class="property-card">
	<a class="card-link" href="<?php echo esc_url( get_permalink( $id ) ); ?>" aria-labelledby="property-title-<?php echo esc_attr( $id ); ?>">
		...
		<div class="card-copy"><div class="card-tags"><span><?php echo esc_html( aspirecre_term_names( $id, 'property_type' ) ); ?></span><span><?php echo esc_html( aspirecre_term_names( $id, 'transaction_type' ) ); ?></span></div>
