...
export async function createDirectoryMap(root,features,actions){
 ...
 const map=new maplibregl.Map({container:root.querySelector('.directory-map'),style:atlasStyle(root.dataset.tiles,root.dataset.glyphs),center:[-95.45,29.82],zoom:9.4,minZoom:7,maxZoom:17,bearing:-7,pitch:0,attributionControl:false,cooperativeGestures:true,renderWorldCopies:false});
